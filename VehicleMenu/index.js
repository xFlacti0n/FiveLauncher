...
//MAIN MENÜ
mp.events.add("client:vehiclemenu:carmenu", (locked,seat, Keys, vehicleid,engine,gurt) => {
...
//KEYBINDS
//Y Fahrzeugmenü Auf/Zu
//K
mp.events.add("client:Keybind:KeyK", () => {
